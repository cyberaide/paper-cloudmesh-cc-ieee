...
The paper is structured as follows. First, we present important requirement aspects that influenced the design and implementation of our work (Section \ref{sec:requirements}).
...
the need varies widely and may include multi-scale hardware resources as
...
includes the use of computing resources but also services that are these
days offered by cloud service providers. A well-known example of this

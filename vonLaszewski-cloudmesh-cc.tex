...
and end node. This is a typical usepattern for DL related analysis tasks.

\subsection{Dependencies}

Each dependency is specified in the {\em dependency} section while
providing sequences of names in a list. In case one wants to execute
nodes in parallel, we can simply define them through a list such as
